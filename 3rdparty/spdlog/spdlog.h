...
inline std::shared_ptr<spdlog::log_manager> create(std::string logger_name, SinkArgs &&...sink_args) {
...
SPDLOG_API void initialize_logger(std::shared_ptr<log_manager> logger);

// Return an existing logger or nullptr if a logger with such name doesn't
// exist.
// example: spdlog::get("my_logger")->info("hello {}", "world");
SPDLOG_API std::shared_ptr<log_manager> get(const std::string &name);
...
SPDLOG_API void register_logger(std::shared_ptr<log_manager> logger);

// Apply a user defined function on all registered loggers
// Example:
// spdlog::apply_all([&](std::shared_ptr<spdlog::logger> l) {l->flush();});
SPDLOG_API void apply_all(const std::function<void(std::shared_ptr<log_manager>)> &fun);
...
SPDLOG_API std::shared_ptr<spdlog::log_manager> default_logger();

SPDLOG_API spdlog::log_manager *default_logger_raw();

SPDLOG_API void set_default_logger(std::shared_ptr<spdlog::log_manager> default_logger);
...
SPDLOG_API void apply_logger_env_levels(std::shared_ptr<log_manager> logger);
