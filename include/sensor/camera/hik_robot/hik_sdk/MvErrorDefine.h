...
#define MV_E_UINT32_LIMIT           0x80000016  ///  \~chinese ͼ���С����unsigned int���أ��ӿڲ�֧��   
#define MV_E_IMAGE_HEIGHT           0x80000017   ///  \~chinese ͼ��߶��쳣����֡������ \~english image height anomaly (discard incomplete images)
...
#define MV_E_SUPPORT_MODIFY_DEVICE_IP   0x8000020E ///< �ڹ̶�IPģʽ�²�֧���޸��豸IPģʽ  \~english Current Mode Not Support Modify Ip
